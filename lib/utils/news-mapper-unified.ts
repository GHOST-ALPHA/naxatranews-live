 ...
 * Priority: coverImage > video thumbnail > placeholder
 * This ensures videos always have a visible thumbnail in listings
 */
export function getBestImageUrl(news: NewsResponse): string {
...
export function mapToContentSidebarArticle(news: NewsResponse): ContentSidebarArticle {
  ...
  return {
    ...
    image: getBestImageUrl(news) || undefined, // Uses coverImage or video thumbnail
    category: category,
    date: publishedDate,
    author: authorName,
  };
