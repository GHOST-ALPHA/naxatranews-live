          ...
          <div className="flex items-center gap-1 flex-1 min-w-0">
            ...
            <div className="flex items-center gap-2 flex-1 min-w-0">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex flex-wrap items-center gap-x-2 gap-y-1">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    {menu.isPublic && (
                      <Badge variant="secondary" className="text-[10px] sm:text-xs px-1 py-0 h-5">
                        Public
                      </Badge>
                    )}
                    {!menu.isActive && (
                      <Badge variant="destructive" className="text-[10px] sm:text-xs px-1 py-0 h-5">
                        Inactive
                      </Badge>
                    )}
                  </div>
              ...
              <div className="hidden sm:flex items-center gap-2 text-xs text-muted-foreground whitespace-nowrap">
                {menu.roleCount > 0 && (
                  <span>Roles: {menu.roleCount}</span>
                )}
                {menu.newsCount > 0 && (
                  <span>News: {menu.newsCount}</span>
                )}
              </div>
            </div>
