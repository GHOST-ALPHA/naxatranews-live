...
export function InsertImageUploadedDialogBody({
  ...
  const handleMediaSelect = (url: string) => {
    // MediaPicker returns the URL from media management system (not base64)
    setSrc(url)
  }
  ...
  return (
    <div className="grid gap-4 py-4">
      <div className="grid gap-2">
        <Label htmlFor="image-upload">Select from Media Library</Label>
        <MediaPicker
          value={src}
      ...
      <DialogFooter>
        <Button
          type="submit"
          disabled={isDisabled}
          onClick={() => onClick({ altText: altText || "Image", src })}
